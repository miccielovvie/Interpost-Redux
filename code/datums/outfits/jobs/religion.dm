...
/decl/hierarchy/outfit/job/priest
	name = OUTFIT_JOB_NAME("Deo Machina Priest")
	uniform = /obj/item/clothing/under/rank/priest
	shoes = /obj/item/clothing/shoes/jackboots
	head = /obj/item/clothing/head/priest
	gloves = /obj/item/clothing/gloves/priest
	glasses = /obj/item/clothing/glasses/priest
	l_ear = /obj/item/device/radio/headset/inquision
	suit = /obj/item/clothing/suit/priest